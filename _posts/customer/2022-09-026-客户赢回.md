...
> 在浪漫喜剧片中，男主角为了获取他追求的女士的芳心，经常采取能够获取她的注意和爱情的夸张的姿势，
...
> 客户流失率，是指在一段时间内停止使用一个应用的客户占比。这个指标阻碍了你的平台的成功。为了有一个成功的app，新客户的数量必须要大于流失的客户数量，。
> 客户流失不但阻碍了你的app的成长，而且它也非常昂贵。
...
> 你可以把客户流失想象为一个漏水的桶：水流出的速度大于你加水的速度，并且你加水的成本可能会很高。
> 
...
> 
> 赢回战略和战术就是有效的使你的沉默客户再次活跃的方法，帮助提高客户终生价值。（这是一个可以计算的指标，如何计算，以后再详解）
...
> 执行那些合适的策略也许能重新吸引不活跃用户的注意，而且可能就是他们重新参与的原因。
> 
...
>### RFM分析
> RFM分别代表近期性、购买频率、购买币值。它是一个市场营销模型，基于客户的历史数据对用户行为进行细分。
...
> ### 制作一个慷慨大方的特价
> 假如你的app有沉默或者丢失的客户，两个有效的选择是通过推送消息通知和有邮箱来触达他们。
> 为特别的用户群体发送量身定制的特价消息是1个非常好的方法，这个方法可以刷存在感。根据客户的地理信息或之前的交易，app开发者很容易定制化推送的消息。
> 
> 假如消费者感觉他获得了一个独特的折扣，那么他会非常可能进行消费，尤其是这个价格仅仅在几天的有效期内。在推送消息或者邮箱里清晰的告知特价的持续日期。
> 
...
>当开发一个app时，每一个特征和元素都几乎会被内部小组讨论成千上百次。接收客户的反馈能提供给你新的关于用户经历和改进的见解。
> 
> 应用内调查能达到13%的响应率，这些说明调查是实时获取活跃用户反馈的非常好的一个工具。
> 
...
> ### 个性化的完美终章
> 每一个消费者都想要自己的内心的声音能够被听到，并且他们的想法能够起到作用。
> 为了获取新客户需要付出高昂的成本，所以保持你的存量客户才是完全值得提上商业优先级的事情。
> 
> 在电子邮件营销过程中，你可以使用个性化的策略，让你的邮件接收人知道你正在注意到他们。
> 包括在标题线下方的他们的名字，邮件内中可以体现出你被他们的个人经历吸引。
> 你也可以利用用户之前的采购习惯数据来定制化的一些服务。
> 
> 你仍然有机会个性化消费者服务过程，可以为他们提供专门的服务代表人，这样他们就能够回答问题并且分析各种问题。
> 
> 提供多种渠道，例如收集、在线沟通、电子邮件这些便利的方式来保证所有的消费者可以联系上客服代表。
> 
...
>### 01. 宝可梦GO
> 宝可梦GO,是一款流行增强的现实手机游戏。自从他们在2016年7月第一次发布以来，已经拥有了破纪录的8亿的下载量。
> 但是他们只有大约5百万的月活用户，这对于有4千5百万的初始玩家数相比是剧烈的下降。
> 
...
> ### 02. 同城快递公司Postmates
> 一个电商品牌为最近没有采购的消费者采用赢回策略是一件非常普通的事情。这个流行的食物快递app Postmates，每周发送交易和折扣的电子邮件给它的订阅者，
> 但有时，这些折扣是通过精心设计的。
> 
> 在一个案例中，Postmates发送了一篇名为"你的秘密折扣是。。。"的电子邮件，目的是为了接收他们制定的折扣。用户不得不点击1个标注清晰的按钮去打开
> 这个app。点击了的用户收到了一次力度很大的折扣，即对配送费进行了75折的折扣，这让消费者激动不已。
> 
...
> ### 03. Skillshare
> 对于订阅性服务，赢回电子邮件是一个挽回损失的业务的方式。Skillshare是一个专注于技能分享的在线教育平台,拥有涉及各类学科的
